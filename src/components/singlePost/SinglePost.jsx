...
export default function SinglePost() {
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/posts/${post._id}`, {data: {username: user.username}});
    ...
    const handleUpdate = async () => {
        try {
            await axios.put(`${process.env.REACT_APP_BACKEND_URL}/posts/${post._id}`, {
